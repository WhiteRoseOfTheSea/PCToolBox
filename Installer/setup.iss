...
AppId={{E7013629-EA8C-48D6-9CE7-C0905EE4AB23}
AppName={#MyAppName}
...
Root: HKLM; Subkey: "Software\PCTools\Toolbox"; ValueType: string; ValueName: "Channel"; ValueData: "{#AppChannel}"
Root: HKLM; Subkey: "Software\PCTools\Toolbox"; ValueType: string; ValueName: "Version"; ValueData: "{#MyAppVersion}"
