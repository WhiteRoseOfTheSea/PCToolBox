...
namespace AtlasToolbox.Views
{
    public sealed partial class HomePage : Page
    {
        ...
        private void LoadFavorites()
        {
            ...
            string keyPath = @"SOFTWARE\PCTools\Toolbox\Favorites";
            using (RegistryKey key = Registry.LocalMachine.OpenSubKey(keyPath))
            {
                ...
                {
                    App.logger.Warn(@$"Key ""HKLM\SOFTWARE\PCTools\Services\Toolbox\Favorites"" was not found");
                }
            }
        ...
        private void MenuFlyoutItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                RegistryHelper.DeleteValue(@"HKLM\SOFTWARE\\PCTools\\Toolbox\\Favorites", menuFlyoutItem.Tag.ToString());
                LoadFavorites();
            }
            catch
            {
