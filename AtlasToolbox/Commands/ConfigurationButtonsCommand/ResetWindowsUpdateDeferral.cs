...
namespace AtlasToolbox.Commands.ConfigurationButtonsCommand
{
    public class ResetWindowsUpdateDeferral : AsyncCommandBase
    {
        ...
        private void ResetUpdateDeferral()
        {
            ...
            const string FEATURE_UDATE_Deferral_KEY = "HKLM\\SOFTWARE\\PCTools\\FeatureUpdateDeferrals";
            const string QUALITY_UPDATE_DeferralS_KEY = "HKLM\\SOFTWARE\\PCTools\\QualityUpdateDeferrals";
            ...
            RegistryHelper.SetValue(FEATURE_UDATE_Deferral_KEY, "path", "C:\\Windows\\PCToolsDesktop\\3. General Configuration\\Windows Updates\\Set Windows Update Deferral.cmd", Microsoft.Win32.RegistryValueKind.DWord);
            ...
            RegistryHelper.SetValue(QUALITY_UPDATE_DeferralS_KEY, "path", "C:\\Windows\\PCToolsDesktop\\3. General Configuration\\Windows Updates\\Set Windows Update Deferral.cmd", Microsoft.Win32.RegistryValueKind.DWord);
