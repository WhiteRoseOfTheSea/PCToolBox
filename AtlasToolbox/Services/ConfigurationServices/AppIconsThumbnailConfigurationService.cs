...
namespace AtlasToolbox.Services.ConfigurationServices
{
    ...
    {
        private const string ATLAS_STORE_KEY_NAME = @"HKLM\SOFTWARE\PCTools\Services\AppIconsThumbnail";
        ...
        public void Disable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\4. Interface Tweaks\File Explorer Customization\App Icons on Thumbnails\Disable App Icons on Thumbnails.cmd");
        ...
        public void Enable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\4. Interface Tweaks\File Explorer Customization\App Icons on Thumbnails\Enable App Icons on Thumbnails (default).cmd");
