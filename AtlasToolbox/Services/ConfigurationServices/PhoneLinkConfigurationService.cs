...
namespace AtlasToolbox.Services.ConfigurationServices
{
    ...
    {
        private const string ATLAS_STORE_KEY_NAME = @"HKLM\SOFTWARE\PCTools\Services\PhoneLink";
        ...
        public void Disable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\3. General Configuration\Mobile Devices (Phone Link)\Disable Mobile Device Settings (default).cmd");

            CommandPromptHelper.RunCommand(@"call %windir%\PCToolsModules\Scripts\settingsPages.cmd /hide mobile-devices");
        ...
        public void Enable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\3. General Configuration\Mobile Devices (Phone Link)\Enable Mobile Device Settings.cmd");

            CommandPromptHelper.RunCommand(@"call %windir%\PCToolsModules\Scripts\settingsPages.cmd /unhide mobile-devices");
