...
namespace PCToolsToolbox.Services.ConfigurationServices
{
    public class BluetoothConfigurationService : IConfigurationService
    {
        private const string ATLAS_STORE_KEY_NAME = @"HKLM\SOFTWARE\PCTools\Services\Bluetooth";
        ...
        public void Disable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\6. Advanced Configuration\Services\Bluetooth\Disable Bluetooth.cmd");
        ...
        public void Enable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\6. Advanced Configuration\Services\Bluetooth\Enable Bluetooth (default).cmd");
