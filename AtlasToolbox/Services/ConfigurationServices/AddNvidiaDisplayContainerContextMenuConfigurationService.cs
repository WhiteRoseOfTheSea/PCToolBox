...
namespace AtlasToolbox.Services.ConfigurationServices
{
    public class AddNvidiaDisplayContainerContextMenuConfigurationService : IConfigurationService
    {
        ...
        private const string ATLAS_STORE_KEY_NAME = @"HKLM\SOFTWARE\PCTools\Services\NVidiaDisplayContainerContextMenu";
        ...
        public void Disable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\6. Advanced Configuration\Services\NVIDIA Display Container\Context Menu\Remove Container Context Menu (default).cmd");
        ...
        public void Enable()
        {
            ...
            RegistryHelper.SetValue(NVIDIA_CONTAINER_001_COMMAND_KEY_NAME, "", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsModules\Toolbox\Scripts\NVidia\EnableNVIDIADisplayContainerLS.cmd", Microsoft.Win32.RegistryValueKind.String);
            ...
            RegistryHelper.SetValue(NVIDIA_CONTAINER_002_COMMAND_KEY_NAME, "", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsModules\Toolbox\Scripts\NVidia\DisableNVIDIADisplayContainerLS.cmd", Microsoft.Win32.RegistryValueKind.String);
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\6. Advanced Configuration\Services\NVIDIA Display Container\Context Menu\Add Container Context Menu.cmd");
