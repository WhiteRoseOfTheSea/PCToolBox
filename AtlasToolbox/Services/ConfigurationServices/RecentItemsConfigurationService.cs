...
namespace AtlasToolbox.Services.ConfigurationServices
{
    ...
    {
        private const string ATLAS_STORE_KEY_NAME = @"HKLM\SOFTWARE\PCTools\Services\RecentItems";
        ...
        public void Disable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\4. Interface Tweaks\Unlock Recent Items\Disable Recent Items (default).cmd");

            CommandPromptHelper.RunCommand(@"call ""%windir%\PCToolsModules\Scripts\settingsPages.cmd"" /hide privacy-general");
        ...
        public void Enable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\4. Interface Tweaks\Unlock Recent Items\Enable Recent Items.cmd");

            CommandPromptHelper.RunCommand(@"call ""%windir%\PCToolsModules\Scripts\settingsPages.cmd"" /unhide privacy-general");
            CommandPromptHelper.RestartExplorer();
        }
