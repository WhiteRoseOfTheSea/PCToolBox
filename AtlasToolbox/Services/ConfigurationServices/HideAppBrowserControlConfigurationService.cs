...
namespace AtlasToolbox.Services.ConfigurationServices
{
    ...
    {
        private const string ATLAS_STORE_KEY_NAME = @"HKLM\SOFTWARE\PCTools\Services\HideAppBrowserControl";
        ...
        public void Disable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\7. Security\Defender\Hide App and Browser Control\Hide App and Browser Control (default).cmd");
        ...
        public void Enable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\7. Security\Defender\Hide App and Browser Control\Show App and Browser Control.cmd");
