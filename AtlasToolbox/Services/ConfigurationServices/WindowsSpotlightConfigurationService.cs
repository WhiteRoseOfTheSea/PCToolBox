...
namespace AtlasToolbox.Services.ConfigurationServices
{
    ...
    {
        private const string ATLAS_STORE_KEY_NAME = @"HKLM\SOFTWARE\PCTools\Services\WindowsSpotlight";
        ...
        public void Disable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\3. General Configuration\Windows Spotlight\Disable Windows Spotlight (default).cmd");
        ...
        public void Enable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\3. General Configuration\Windows Spotlight\Enable Windows Spotlight.cmd");
