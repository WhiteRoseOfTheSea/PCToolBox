...
namespace AtlasToolbox.Services.ConfigurationServices
{
    ...
    {
        private const string ATLAS_STORE_KEY_NAME = @"HKLM\SOFTWARE\PCTools\Services\FSOGameBar";
        ...
        public void Disable()
        {
            // TODO change the directory of the ProcessStartInfo since this will probably not be in PCToolsDesktop anymore.
            // This is also a placeholder since I am unsure of how to make it run with RunAsTI.cmd

            CommandPromptHelper.RunCommand(@"call \%windir%\PCToolsDesktop\3. General Configuration\FSO and Game Bar\Disable FSO and Game Bar Support.cmd");
            ...
            //RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\3. General Configuration\FSO and Game Bar\Disable FSO and Game Bar Support.cmd");
        ...
        public void Enable()
        {
            CommandPromptHelper.RunCommand(@"call \%windir%\PCToolsDesktop\3. General Configuration\FSO and Game Bar\Enable FSO and Game Bar Support (default).cmd");
            ...
            //RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\3. General Configuration\FSO and Game Bar\Enable FSO and Game Bar Support (default).cmd");
