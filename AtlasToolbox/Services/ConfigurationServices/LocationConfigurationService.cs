...
namespace AtlasToolbox.Services.ConfigurationServices
{
    ...
    {
        private const string ATLAS_STORE_KEY_NAME = @"HKLM\SOFTWARE\PCTools\Services\Location";
        ...
        public void Disable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\3. General Configuration\Location\Disable Location (default).cmd");

            CommandPromptHelper.RunCommand("sc stop lfscv");
            CommandPromptHelper.RunCommand("sc stop MapsBroker");
            CommandPromptHelper.RunCommand("call \"%windir%\\PCToolsModules\\Scripts\\settingsPages.cmd\" /hide privacy-location");
            CommandPromptHelper.RunCommand("call \"%windir%\\PCToolsModules\\Scripts\\settingsPages.cmd\" /hide findmydevice");
        ...
        public void Enable()
        {
            ...
            RegistryHelper.SetValue(ATLAS_STORE_KEY_NAME, "path", @$"{Environment.GetEnvironmentVariable("windir")}\PCToolsDesktop\3. General Configuration\Location\Enable Location.cmd");

            CommandPromptHelper.RunCommand("sc start lfscv");
            CommandPromptHelper.RunCommand("sc start MapsBroker");
            CommandPromptHelper.RunCommand("call \"%windir%\\PCToolsModules\\Scripts\\settingsPages.cmd\" /unhide privacy-location");
            CommandPromptHelper.RunCommand("call \"%windir%\\PCToolsModules\\Scripts\\settingsPages.cmd\" /unhide findmydevice");
