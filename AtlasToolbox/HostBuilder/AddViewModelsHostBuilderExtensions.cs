    ...
    public static class AddViewModelsHostBuilderExtensions
    {
        ...
        private static IHostBuilder AddConfigurationButtonItemViewModels(this IHostBuilder host)
        {
            ...
            Dictionary<string, ConfigurationButton> configurationDictionary = new()
            {
                ...
                ["InstallDrivers"] = new(buttonCommand = new InstallDriversCommand(), App.GetValueFromItemList("InstallDrivers"), App.GetValueFromItemList("InstallDrivers", true), ConfigurationType.DriverConfigurationSubMenu, "\uE9CE"),
                ["UninstallDriverTool"] = new(buttonCommand = new UninstallDriverToolCommand(), App.GetValueFromItemList("UninstallDriverTool"), App.GetValueFromItemList("UninstallDriverToolDescription"), ConfigurationType.DriverConfigurationSubMenu, ""),
                ...
                ["RemoveOffice"] = new(buttonCommand = new RemoveOfficeCommand(), App.GetValueFromItemList("RemoveOffice"), App.GetValueFromItemList("RemoveOfficeDescription"), ConfigurationType.Troubleshooting, "\uE74D"),
                ["SetLanguageItalian"] = new(buttonCommand = new SetLanguageItalianCommand(), App.GetValueFromItemList("SetLanguageItalian"), App.GetValueFromItemList("SetLanguageItalianDescription"), ConfigurationType.Windows, "\uE74D"),
                ["SetLanguageEnglish"] = new(buttonCommand = new SetLanguageEnglishCommand(), App.GetValueFromItemList("SetLanguageEnglish"), App.GetValueFromItemList("SetLanguageEnglishDescription"), ConfigurationType.Windows, "\uE74D"),
        ...
        private static IHostBuilder AddConfigurationItemViewModels(this IHostBuilder host)
        {
            ...
            Dictionary<string, Configuration> configurationDictionary = new()
            {
                ...
                ["DesktopIcons"] = new(App.GetValueFromItemList("DesktopIcons"), "DesktopIcons", ConfigurationType.Interface),
