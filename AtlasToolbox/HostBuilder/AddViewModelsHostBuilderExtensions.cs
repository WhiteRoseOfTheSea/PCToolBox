...
namespace AtlasToolbox.HostBuilder
{
    public static class AddViewModelsHostBuilderExtensions
    {
        ...
        private static IHostBuilder AddProfiles(this IHostBuilder host)
        {
            ...
            DirectoryInfo profilesDirectory = new DirectoryInfo($"{Environment.GetEnvironmentVariable("windir")}\\PCToolsModules\\Toolbox\\Profiles");
            try
            {
            ...
            {
                Directory.CreateDirectory($"{Environment.GetEnvironmentVariable("windir")}\\PCToolsModules\\Toolbox\\Profiles");
            }
            finally
            {
                FileInfo[] profileFile = profilesDirectory.GetFiles();
        ...
        private static IHostBuilder AddConfigurationButtonItemViewModels(this IHostBuilder host)
        {
            ...
            Dictionary<string, ConfigurationButton> configurationDictionary = new()
            {
                ...
                ["InstallDrivers"] = new(buttonCommand = new InstallDriversCommand(), App.GetValueFromItemList("InstallDrivers"), App.GetValueFromItemList("InstallDrivers", true), ConfigurationType.Custom, "\uE9CE"),
                ["UninstallDriverTool"] = new(buttonCommand = new UninstallDriverToolCommand(), App.GetValueFromItemList("UninstallDriverTool"), App.GetValueFromItemList("UninstallDriverToolDescription"), ConfigurationType.Custom, ""),
                ...
                ["RemoveOffice"] = new(buttonCommand = new RemoveOfficeCommand(), App.GetValueFromItemList("RemoveOffice"), App.GetValueFromItemList("RemoveOfficeDescription"), ConfigurationType.Custom, "\uE74D"),
                ["SetLanguageItalian"] = new(buttonCommand = new SetLanguageItalianCommand(), App.GetValueFromItemList("SetLanguageItalian"), App.GetValueFromItemList("SetLanguageItalianDescription"), ConfigurationType.Custom, "\uE74D"),
                ["SetLanguageEnglish"] = new(buttonCommand = new SetLanguageEnglishCommand(), App.GetValueFromItemList("SetLanguageEnglish"), App.GetValueFromItemList("SetLanguageEnglishDescription"), ConfigurationType.Custom, "\uE74D"),
                ["ExtendDisk"] = new(buttonCommand = new ExtendDiskCommand(), App.GetValueFromItemList("ExtendDisk"), App.GetValueFromItemList("ExtendDiskDescription"), ConfigurationType.Custom, ""),
                ["OpenNetplwiz"] = new(buttonCommand = new OpenNetplwizCommand(), App.GetValueFromItemList("OpenNetplwiz"), App.GetValueFromItemList("OpenNetplwizDescription"), ConfigurationType.Custom, ""),
        ...
        private static IHostBuilder AddConfigurationItemViewModels(this IHostBuilder host)
        {
            ...
            Dictionary<string, Configuration> configurationDictionary = new()
            {
                ...
                ["DesktopIcons"] = new(App.GetValueFromItemList("DesktopIcons"), "DesktopIcons", ConfigurationType.Custom),
